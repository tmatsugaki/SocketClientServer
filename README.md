...
## Windows11 WSLにLinuxをインストールし上記の手順を実施したのち、更に下記を実施することでクロス開発環境を整備する試み
...
Windows11 の WSL2 で費やしたことが徒労に終わる可能性がありますから、デバイスを楽に扱えるクロス開発環境として PC上のネイティブの ubuntu 22.04 若しくは macOS を推奨します。
